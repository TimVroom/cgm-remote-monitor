...
describe('admintools', function (this: any) {
  const self = this;
  self.timeout(45000); // TODO: see why this test takes longer on CI to complete
  ...
  it('should produce some html', function (done) {
    ...
    console.error($('#admin_cleanstatusdb_0_html + button').text(), $('#admin_cleanstatusdb_0_html + button').text().should);
