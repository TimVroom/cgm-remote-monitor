...
var fs = require('fs')
  ...
  , http = require('http')
  // @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'https'.
  , https = require('https')
  // @ts-expect-error TS(2591): Cannot find name 'require'. Do you need to install... Remove this comment to see the full error message
...
function configure () {
  ...
  // @ts-expect-error TS(2339): Property 'prepareEnv' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339): Property 'addSecuredOperations' does not exist on ... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339): Property 'bindSocket' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339): Property 'unbindSocket' does not exist on type '{}... Remove this comment to see the full error message
   ...
   */
  // @ts-expect-error TS(2339): Property 'create' does not exist on type '{}'.
  self.create = function createHttpServer ({
    ...
    return new Promise(function (resolve, reject) {
      ...
      try {
        ...
        // @ts-expect-error TS(2339): Property 'wares' does not exist on type '{}'.
        self.wares = require('../../../lib/middleware/')(instance.env);
        // @ts-expect-error TS(2339): Property 'app' does not exist on type '{}'.
        ...
        require('../../../lib/server/bootevent')(instance.env, language).boot(function booted (ctx: any) {
          ...
          // @ts-expect-error TS(2339): Property 'server' does not exist on type '{}'.
          ...
          // @ts-expect-error TS(2339): Property 'cacheMonitor' does not exist on type '{}... Remove this comment to see the full error message
          ...
          self.bindSocket(storageSocket, instance)
            .then((socket: any) => {
              // @ts-expect-error TS(2339): Property 'clientSocket' does not exist on type '{}... Remove this comment to see the full error message
