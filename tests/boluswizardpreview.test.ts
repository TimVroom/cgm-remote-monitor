...
describe('boluswizardpreview', function ( ) {
 ...
 it('should calculate IOB results correctly with 1.0 U IOB resulting in going low in MMOL', function (done: any) {
    ...
    // @ts-expect-error TS(2339) FIXME: Property 'treatments' does not exist on type '{ sg... Remove this comment to see the full error message
    ...
    data.devicestatus = [];
    // @ts-expect-error TS(2339) FIXME: Property 'profile' does not exist on type '{ sgvs:... Remove this comment to see the full error message
