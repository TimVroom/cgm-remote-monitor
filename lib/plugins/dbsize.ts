...
function init (ctx: any) {
  ...
  dbsize.analyzeData = function analyzeData (sbx: any) {
    ...
    // @ts-expect-error TS(2339) FIXME: Property 'totalDataSize' does not exist on type '{... Remove this comment to see the full error message
    result.totalDataSize = totalDataSize;
    // @ts-expect-error TS(2339) FIXME: Property 'dataPercentage' does not exist on type '... Remove this comment to see the full error message
    result.dataPercentage = dataPercentage;
    // @ts-expect-error TS(2339) FIXME: Property 'notificationLevel' does not exist on typ... Remove this comment to see the full error message
    result.notificationLevel = ctx.levels.INFO;
    // @ts-expect-error TS(2339) FIXME: Property 'details' does not exist on type '{ level... Remove this comment to see the full error message
    result.details = {
