...
function init(ctx: any) {
  ...
  timeago.checkNotifications = function checkNotifications(sbx: any) {
    ...
    function sendAlarm(opts: any) {
      // @ts-expect-error TS(2339) FIXME: Property 'calcDisplay' does not exist on type '{ n... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339) FIXME: Property 'checkStatus' does not exist on type '{ n... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'isMissing' does not exist on type '{ nam... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'inTheFuture' does not exist on type '{ n... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'almostInTheFuture' does not exist on typ... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'isLessThan' does not exist on type '{ na... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'resolvers' does not exist on type '{ nam... Remove this comment to see the full error message
  timeago.resolvers = [
    // @ts-expect-error TS(2339) FIXME: Property 'isMissing' does not exist on type '{ nam... Remove this comment to see the full error message
  ...
  timeago.calcDisplay = function calcDisplay(entry: any, time: any) {
    ...
    if (time && entry && entry.mills) {
      // @ts-expect-error TS(2339) FIXME: Property 'timeSince' does not exist on type '{ tim... Remove this comment to see the full error message
