...
function config () {
  ...
  // @ts-expect-error TS(2339): Property 'IMPORT_CONFIG' does not exist on type '{... Remove this comment to see the full error message
  env.IMPORT_CONFIG = readENV('IMPORT_CONFIG', null);
  // @ts-expect-error TS(2339): Property 'static_files' does not exist on type '{ ... Remove this comment to see the full error message
  env.static_files = readENV('NIGHTSCOUT_STATIC_FILES', '/static');
  // @ts-expect-error TS(2339): Property 'debug' does not exist on type '{ setting... Remove this comment to see the full error message
  env.debug = {
    minify: readENVTruthy('DEBUG_MINIFY', true)
  };

  // @ts-expect-error TS(2339): Property 'err' does not exist on type '{ settings:... Remove this comment to see the full error message
  env.err = [];
  // @ts-expect-error TS(2339): Property 'notifies' does not exist on type '{ sett... Remove this comment to see the full error message
  env.notifies = [];
  // @ts-expect-error TS(2339): Property 'enclave' does not exist on type '{ setti... Remove this comment to see the full error message
  env.enclave = enclave();
...
function setSSL () {
  // @ts-expect-error TS(2339): Property 'SSL_KEY' does not exist on type '{ setti... Remove this comment to see the full error message
  env.SSL_KEY = readENV('SSL_KEY');
  // @ts-expect-error TS(2339): Property 'SSL_CERT' does not exist on type '{ sett... Remove this comment to see the full error message
  env.SSL_CERT = readENV('SSL_CERT');
  // @ts-expect-error TS(2339): Property 'SSL_CA' does not exist on type '{ settin... Remove this comment to see the full error message
  ...
  if (env.SSL_KEY && env.SSL_CERT) {
    ...
    // @ts-expect-error TS(2339): Property 'SSL_CA' does not exist on type '{ settin... Remove this comment to see the full error message
    if (env.SSL_CA) {
      // @ts-expect-error TS(2339): Property 'ca' does not exist on type '{ settings: ... Remove this comment to see the full error message
      env.ca = fs.readFileSync(env.SSL_CA);
    }
  }

  // @ts-expect-error TS(2339): Property 'insecureUseHttp' does not exist on type ... Remove this comment to see the full error message
  env.insecureUseHttp = readENVTruthy("INSECURE_USE_HTTP", false);
  // @ts-expect-error TS(2339): Property 'secureHstsHeader' does not exist on type... Remove this comment to see the full error message
  env.secureHstsHeader = readENVTruthy("SECURE_HSTS_HEADER", true);
  // @ts-expect-error TS(2339): Property 'secureHstsHeaderIncludeSubdomains' does ... Remove this comment to see the full error message
  env.secureHstsHeaderIncludeSubdomains = readENVTruthy("SECURE_HSTS_HEADER_INCLUDESUBDOMAINS", false);
  // @ts-expect-error TS(2339): Property 'secureHstsHeaderPreload' does not exist ... Remove this comment to see the full error message
  env.secureHstsHeaderPreload = readENVTruthy("SECURE_HSTS_HEADER_PRELOAD", false);
  // @ts-expect-error TS(2339): Property 'secureCsp' does not exist on type '{ set... Remove this comment to see the full error message
  env.secureCsp = readENVTruthy("SECURE_CSP", false);
  // @ts-expect-error TS(2339): Property 'secureCspReportOnly' does not exist on t... Remove this comment to see the full error message
...
function setAPISecret () {
  ...
  // @ts-expect-error TS(2339): Property 'api_secret' does not exist on type '{ se... Remove this comment to see the full error message
  env.api_secret = null;
  ...
  if (useSecret) {
    ...
    if (readENV('API_SECRET').length < consts.MIN_PASSPHRASE_LENGTH) {
      ...
      // @ts-expect-error TS(2339): Property 'storageURI' does not exist on type '{ se... Remove this comment to see the full error message
      if (env.storageURI) {
        // @ts-expect-error TS(2339): Property 'storageURI' does not exist on type '{ se... Remove this comment to see the full error message
...
function setVersion () {
  ...
  // @ts-expect-error TS(2339): Property 'version' does not exist on type '{ setti... Remove this comment to see the full error message
  env.version = software.version;
  // @ts-expect-error TS(2339): Property 'name' does not exist on type '{ settings... Remove this comment to see the full error message
...
function setStorage () {
  ...
  // @ts-expect-error TS(2339): Property 'entries_collection' does not exist on ty... Remove this comment to see the full error message
  env.entries_collection = readENV('ENTRIES_COLLECTION') || readENV('MONGO_COLLECTION', 'entries');
  // @ts-expect-error TS(2339): Property 'authentication_collections_prefix' does ... Remove this comment to see the full error message
  env.authentication_collections_prefix = readENV('MONGO_AUTHENTICATION_COLLECTIONS_PREFIX', 'auth_');
  // @ts-expect-error TS(2339): Property 'treatments_collection' does not exist on... Remove this comment to see the full error message
  env.treatments_collection = readENV('MONGO_TREATMENTS_COLLECTION', 'treatments');
  // @ts-expect-error TS(2339): Property 'profile_collection' does not exist on ty... Remove this comment to see the full error message
  env.profile_collection = readENV('MONGO_PROFILE_COLLECTION', 'profile');
  // @ts-expect-error TS(2339): Property 'settings_collection' does not exist on t... Remove this comment to see the full error message
  env.settings_collection = readENV('MONGO_SETTINGS_COLLECTION', 'settings');
  // @ts-expect-error TS(2339): Property 'devicestatus_collection' does not exist ... Remove this comment to see the full error message
  env.devicestatus_collection = readENV('MONGO_DEVICESTATUS_COLLECTION', 'devicestatus');
  // @ts-expect-error TS(2339): Property 'food_collection' does not exist on type ... Remove this comment to see the full error message
  env.food_collection = readENV('MONGO_FOOD_COLLECTION', 'food');
  // @ts-expect-error TS(2339): Property 'activity_collection' does not exist on t... Remove this comment to see the full error message
