...
function configure (env: any, ctx: any) {
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'setENVTruthy' does not exist on type '{}... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'setupApiEnvironment' does not exist on t... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'setupApiRoutes' does not exist on type '... Remove this comment to see the full error message
