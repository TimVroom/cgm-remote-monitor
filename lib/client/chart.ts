...
function init (client: any, d3: any, $: any) {
  ...
  function beforeBrushStarted(this: any) {
    ...
    var now = new Date();
    // @ts-expect-error TS(2339): Property 'xScale2' does not exist on type '{}'.
    ...
    // @ts-expect-error TS(2339): Property 'theBrush' does not exist on type '{}'.
  ...
  function brushEnded () {
    // update the opacity of the context data points to brush extent
    // @ts-expect-error TS(2339): Property 'createAdjustedRange' does not exist on t... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339): Property 'xScale' does not exist on type '{}'.
  var xScale = chart.xScale = d3.scaleTime().domain(extent);

  focusYDomain = dynamicDomainOrElse(focusYDomain);
  // @ts-expect-error TS(2339): Property 'yScale' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339): Property 'yScale2' does not exist on type '{}'.
  var yScale2 = chart.yScale2 = yScaleType()
    .domain(contextYDomain);

  // @ts-expect-error TS(2339): Property 'xScaleBasals' does not exist on type '{}... Remove this comment to see the full error message
  chart.xScaleBasals = d3.scaleTime().domain(extent);

  // @ts-expect-error TS(2339): Property 'yScaleBasals' does not exist on type '{}... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339): Property 'xAxis' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339): Property 'yAxis' does not exist on type '{}'.
  chart.yAxis = d3.axisLeft(yScale)
    .tickFormat(d3.format('d'))
    .tickValues(tickValues);

  // @ts-expect-error TS(2339): Property 'xAxis2' does not exist on type '{}'.
  chart.xAxis2 = d3.axisBottom(xScale2)
    .tickFormat(tickFormat)
    .ticks(6);

  // @ts-expect-error TS(2339): Property 'yAxis2' does not exist on type '{}'.
  ...
  // setup a brush
  // @ts-expect-error TS(2339): Property 'brush' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339): Property 'futureOpacity' does not exist on type '{... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339): Property 'basals' does not exist on type '{}'.
  chart.basals = chart.charts.append('g').attr('class', 'chart-basals');

  // @ts-expect-error TS(2339): Property 'focus' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339): Property 'createBrushedRange' does not exist on ty... Remove this comment to see the full error message
  chart.createBrushedRange = function() {
    ...
    // @ts-expect-error TS(2339): Property 'inRetroMode' does not exist on type '{}'... Remove this comment to see the full error message
  ...
  chart.update = function update (init: any) {
    ...
    // @ts-expect-error TS(2339): Property 'setForecastTime' does not exist on type ... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339): Property 'focusHeight' does not exist on type '{}'... Remove this comment to see the full error message
    var focusHeight = chart.focusHeight = chartHeight * .7;
    // @ts-expect-error TS(2339): Property 'contextHeight' does not exist on type '{... Remove this comment to see the full error message
    var contextHeight = chart.contextHeight = chartHeight * .3;
    // @ts-expect-error TS(2339): Property 'basalsHeight' does not exist on type '{}... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339): Property 'prevChartWidth' does not exist on type '... Remove this comment to see the full error message
    var widthChanged = (chart.prevChartWidth !== chartWidth);
    // @ts-expect-error TS(2339): Property 'prevChartHeight' does not exist on type ... Remove this comment to see the full error message
    ...
    // @ts-expect-error TS(2339): Property 'updateContext' does not exist on type '{... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339): Property 'scroll' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339): Property 'getMaxForecastMills' does not exist on t... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339): Property 'getForecastData' does not exist on type ... Remove this comment to see the full error message
