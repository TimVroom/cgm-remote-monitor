...
// @ts-expect-error TS(2339) FIXME: Property 'init' does not exist on type '{ initiali... Remove this comment to see the full error message
hashauth.init = function init (client: any, $: any) {

  // @ts-expect-error TS(2339) FIXME: Property 'apisecret' does not exist on type '{ ini... Remove this comment to see the full error message
  hashauth.apisecret = '';
  // @ts-expect-error TS(2339) FIXME: Property 'storeapisecret' does not exist on type '... Remove this comment to see the full error message
  hashauth.storeapisecret = false;
  // @ts-expect-error TS(2339) FIXME: Property 'apisecrethash' does not exist on type '{... Remove this comment to see the full error message
  hashauth.apisecrethash = null;
  // @ts-expect-error TS(2339) FIXME: Property 'authenticated' does not exist on type '{... Remove this comment to see the full error message
  hashauth.authenticated = false;
  // @ts-expect-error TS(2339) FIXME: Property 'tokenauthenticated' does not exist on ty... Remove this comment to see the full error message
  hashauth.tokenauthenticated = false;
  // @ts-expect-error TS(2339) FIXME: Property 'hasReadPermission' does not exist on typ... Remove this comment to see the full error message
  hashauth.hasReadPermission = false;
  // @ts-expect-error TS(2339) FIXME: Property 'isAdmin' does not exist on type '{ initi... Remove this comment to see the full error message
  hashauth.isAdmin = false;
  // @ts-expect-error TS(2339) FIXME: Property 'hasWritePermission' does not exist on ty... Remove this comment to see the full error message
  hashauth.hasWritePermission = false;
  // @ts-expect-error TS(2339) FIXME: Property 'permissionlevel' does not exist on type ... Remove this comment to see the full error message
  hashauth.permissionlevel = 'NONE';

  // @ts-expect-error TS(2339) FIXME: Property 'verifyAuthentication' does not exist on ... Remove this comment to see the full error message
  hashauth.verifyAuthentication = function verifyAuthentication (next: any) {
    ...
    $.ajax({
      ...
      // @ts-expect-error TS(2339) FIXME: Property 'removeAuthentication' does not exist on ... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'injectHtml' does not exist on type '{ in... Remove this comment to see the full error message
  hashauth.injectHtml = function injectHtml () {
    // @ts-expect-error TS(2339) FIXME: Property 'injectedHtml' does not exist on type '{ ... Remove this comment to see the full error message
    if (!hashauth.injectedHtml) {
      // @ts-expect-error TS(2339) FIXME: Property 'inlineCode' does not exist on type '{ in... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'initAuthentication' does not exist on ty... Remove this comment to see the full error message
  hashauth.initAuthentication = function initAuthentication (next: any) {
    ...
    hashauth.verifyAuthentication(function() {
      // @ts-expect-error TS(2339) FIXME: Property 'injectHtml' does not exist on type '{ in... Remove this comment to see the full error message
      hashauth.injectHtml();
      // @ts-expect-error TS(2339) FIXME: Property 'isAuthenticated' does not exist on type ... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'requestAuthentication' does not exist on... Remove this comment to see the full error message
      ...
      , buttons: [
        {
          ...
          , click: function() {
            var dialog = this;
            // @ts-expect-error TS(2339) FIXME: Property 'processSecret' does not exist on type '{... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'updateSocketAuth' does not exist on type... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'hash' does not exist on type '{ initiali... Remove this comment to see the full error message
