...
function init (env: any) {
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'addFailedRequest' does not exist on type... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'shouldDelayRequest' does not exist on ty... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'requestSucceeded' does not exist on type... Remove this comment to see the full error message
