...
function init (env: any, ctx: any) {
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'queryOpts' does not exist on type '{}'.
  storage.queryOpts = {
  ...
  function create (collection: any) {
    function doCreate(obj: any, fn: any) {
      ...
      collection.insert(obj, function (err: any, doc: any) {
        ...
        // @ts-expect-error TS(2339) FIXME: Property 'reload' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'createSubject' does not exist on type '{... Remove this comment to see the full error message
  storage.createSubject = create(subjectsCollection);
  // @ts-expect-error TS(2339) FIXME: Property 'saveSubject' does not exist on type '{}'... Remove this comment to see the full error message
  storage.saveSubject = save(subjectsCollection);
  // @ts-expect-error TS(2339) FIXME: Property 'removeSubject' does not exist on type '{... Remove this comment to see the full error message
  storage.removeSubject = remove(subjectsCollection);
  // @ts-expect-error TS(2339) FIXME: Property 'listSubjects' does not exist on type '{}... Remove this comment to see the full error message
  storage.listSubjects = list(subjectsCollection);

  // @ts-expect-error TS(2339) FIXME: Property 'createRole' does not exist on type '{}'.
  storage.createRole = create(rolesCollection);
  // @ts-expect-error TS(2339) FIXME: Property 'saveRole' does not exist on type '{}'.
  storage.saveRole = save(rolesCollection);
  // @ts-expect-error TS(2339) FIXME: Property 'removeRole' does not exist on type '{}'.
  storage.removeRole = remove(rolesCollection);
  // @ts-expect-error TS(2339) FIXME: Property 'listRoles' does not exist on type '{}'.
  storage.listRoles = list(rolesCollection);

  // @ts-expect-error TS(2339) FIXME: Property 'defaultRoles' does not exist on type '{}... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'getSHA1' does not exist on type '{}'.
  ...
  storage.reload = function reload (callback: any) {
    ...
    storage.listRoles({sort: {name: 1}}, function listResults (err: any, results: any) {
      ...
      // @ts-expect-error TS(2339) FIXME: Property 'roles' does not exist on type '{}'.
      ...
      storage.listSubjects({sort: {name: 1}}, function listResults (err: any, results: any) {
        ...
        // @ts-expect-error TS(2339) FIXME: Property 'subjects' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'findRole' does not exist on type '{}'.
  storage.findRole = function findRole (roleName: any) {
    // @ts-expect-error TS(2339) FIXME: Property 'roles' does not exist on type '{}'.
    return _.find(storage.roles, {name: roleName});
  };

  // @ts-expect-error TS(2339) FIXME: Property 'roleToShiro' does not exist on type '{}'... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'rolesToShiros' does not exist on type '{... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'roleToPermissions' does not exist on typ... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'findSubject' does not exist on type '{}'... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'doesAccessTokenExist' does not exist on ... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'resolveSubjectAndPermissions' does not e... Remove this comment to see the full error message
