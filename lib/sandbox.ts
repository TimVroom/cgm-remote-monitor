...
function init () {
  ...
  function reset () {
    // @ts-expect-error TS(2339) FIXME: Property 'properties' does not exist on type '{}'.
    sbx.properties = {};
  }

  function extend () {
    // @ts-expect-error TS(2339) FIXME: Property 'unitsLabel' does not exist on type '{}'.
   ...
   * @returns {{sbx}}
   */
  // @ts-expect-error TS(2339) FIXME: Property 'serverInit' does not exist on type '{}'.
  sbx.serverInit = function serverInit (env: any, ctx: any) {
    reset();

    // @ts-expect-error TS(2339) FIXME: Property 'runtimeEnvironment' does not exist on ty... Remove this comment to see the full error message
    sbx.runtimeEnvironment = 'server';
    // @ts-expect-error TS(2339) FIXME: Property 'runtimeState' does not exist on type '{}... Remove this comment to see the full error message
    sbx.runtimeState = ctx.runtimeState;
    // @ts-expect-error TS(2339) FIXME: Property 'time' does not exist on type '{}'.
    sbx.time = Date.now();
    ...
    // @ts-expect-error TS(2339) FIXME: Property 'withExtendedSettings' does not exist on ... Remove this comment to see the full error message
   ...
   * @returns {{sbx}}
   */
  // @ts-expect-error TS(2339) FIXME: Property 'clientInit' does not exist on type '{}'.
  sbx.clientInit = function clientInit (ctx: any, time: any, data: any) {
    ...
    // @ts-expect-error TS(2339) FIXME: Property 'showPlugins' does not exist on type '{}'... Remove this comment to see the full error message
    sbx.showPlugins = ctx.settings.showPlugins;
    // @ts-expect-error TS(2339) FIXME: Property 'time' does not exist on type '{}'.
    sbx.time = time;
    // @ts-expect-error TS(2339) FIXME: Property 'data' does not exist on type '{}'.
    sbx.data = data;
    // @ts-expect-error TS(2339) FIXME: Property 'pluginBase' does not exist on type '{}'.
   ...
   * @param setter
   */
  // @ts-expect-error TS(2339) FIXME: Property 'offerProperty' does not exist on type '{... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'isCurrent' does not exist on type '{}'.
  sbx.isCurrent = function isCurrent (entry: any) {
    // @ts-expect-error TS(2339) FIXME: Property 'time' does not exist on type '{}'.
    return entry && sbx.time - entry.mills <= times.mins(15).msecs;
  };

  // @ts-expect-error TS(2339) FIXME: Property 'lastEntry' does not exist on type '{}'.
  sbx.lastEntry = function lastEntry (entries: any) {
    return _.findLast(entries, function notInTheFuture (entry: any) {
      // @ts-expect-error TS(2339) FIXME: Property 'entryMills' does not exist on type '{}'.
      return sbx.entryMills(entry) <= sbx.time;
    });
  };

  // @ts-expect-error TS(2339) FIXME: Property 'lastNEntries' does not exist on type '{}... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'prevEntry' does not exist on type '{}'.
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'prevSGVEntry' does not exist on type '{}... Remove this comment to see the full error message
  sbx.prevSGVEntry = function prevSGVEntry () {
    // @ts-expect-error TS(2339) FIXME: Property 'prevEntry' does not exist on type '{}'.
    return sbx.prevEntry(sbx.data.sgvs);
  };

  // @ts-expect-error TS(2339) FIXME: Property 'lastSGVEntry' does not exist on type '{}... Remove this comment to see the full error message
  sbx.lastSGVEntry = function lastSGVEntry () {
    // @ts-expect-error TS(2339) FIXME: Property 'lastEntry' does not exist on type '{}'.
    return sbx.lastEntry(sbx.data.sgvs);
  };

  // @ts-expect-error TS(2339) FIXME: Property 'lastSGVMgdl' does not exist on type '{}'... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'lastSGVMills' does not exist on type '{}... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'lastScaledSGV' does not exist on type '{... Remove this comment to see the full error message
  sbx.lastScaledSGV = function lastScaledSVG () {
    // @ts-expect-error TS(2339) FIXME: Property 'scaleEntry' does not exist on type '{}'.
    return sbx.scaleEntry(sbx.lastSGVEntry());
  };

  // @ts-expect-error TS(2339) FIXME: Property 'lastDisplaySVG' does not exist on type '... Remove this comment to see the full error message
  sbx.lastDisplaySVG = function lastDisplaySVG () {
    // @ts-expect-error TS(2339) FIXME: Property 'displayBg' does not exist on type '{}'.
    return sbx.displayBg(sbx.lastSGVEntry());
  };

  // @ts-expect-error TS(2339) FIXME: Property 'buildBGNowLine' does not exist on type '... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'propertyLine' does not exist on type '{}... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'appendPropertyLine' does not exist on ty... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'prepareDefaultLines' does not exist on t... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'buildDefaultMessage' does not exist on t... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'roundInsulinForDisplayFormat' does not e... Remove this comment to see the full error message
  ...
  // @ts-expect-error TS(2339) FIXME: Property 'roundBGToDisplayFormat' does not exist o... Remove this comment to see the full error message
